module github.com/therealpaulgg/recipe-book-proxy
...
require (
	...
	github.com/therealpaulgg/ssh-sync v0.3.0 // indirect
	github.com/therealpaulgg/ssh-sync-server v0.3.1 // indirect
